 ...
 * @returns
 */
export const svg_element = str =>
  document.createElementNS("http://www.w3.org/2000/svg", str);

export const line = (vec0, vec1) => {
  const l = svg_element("line");
...
export const rect = (vec0, vec1, rot) => {
  const rectangle = svg_element("rect");
